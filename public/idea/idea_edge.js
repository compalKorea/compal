    ...
    content: {
            ...
            },
            {
                ...
                c: [
                {
                    id: 'bomb',
                    type: 'image',
                    rect: ['43.7%', '44.2%','115px','102px','auto', 'auto'],
                    fill: ["rgba(0,0,0,0)",im+"bomb.png",'0px','0px']
                },
                {
                    id: 'bomb_bom',
                    type: 'image',
                    rect: ['41.3%', '35.7%','130px','121px','auto', 'auto'],
            ...
            },
            {
                id: 'closed',
                type: 'image',
                rect: ['94.6%', '2.4%','45px','39px','auto', 'auto'],
                cursor: ['pointer'],
                fill: ["rgba(0,0,0,0)",im+"closed.png",'0px','0px']
            }],
            symbolInstances: [
            {
                id: 'tet',
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid6027", tween: [ "style", "${_bomb_bom}", "width", '473px', { fromValue: '130px'}], position: 16635, duration: 201 },
                { id: "eid6037", tween: [ "style", "${_bomb_bom}", "width", '385px', { fromValue: '473px'}], position: 16836, duration: 164 },
                ...
                { id: "eid7430", tween: [ "style", "${_fla}", "-moz-transform-origin", [0,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,100]}], position: 9415, duration: 0 },
                { id: "eid7431", tween: [ "style", "${_fla}", "-ms-transform-origin", [0,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,100]}], position: 9415, duration: 0 },
                { id: "eid7432", tween: [ "style", "${_fla}", "msTransformOrigin", [0,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,100]}], position: 9415, duration: 0 },
                { id: "eid7433", tween: [ "style", "${_fla}", "-o-transform-origin", [0,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,100]}], position: 9415, duration: 0 },
                ...
                { id: "eid5993", tween: [ "style", "${_bomb}", "height", '154px', { fromValue: '102px'}], position: 15676, duration: 409 },
                ...
                { id: "eid6026", tween: [ "style", "${_bomb_bom}", "height", '444px', { fromValue: '121px'}], position: 16635, duration: 201 },
                { id: "eid6034", tween: [ "style", "${_bomb_bom}", "height", '361px', { fromValue: '444px'}], position: 16836, duration: 164 },
                ...
                { id: "eid7434", tween: [ "style", "${_mouse}", "-moz-transform-origin", [50,50], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,50]}], position: 2500, duration: 0 },
                { id: "eid7435", tween: [ "style", "${_mouse}", "-ms-transform-origin", [50,50], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,50]}], position: 2500, duration: 0 },
                { id: "eid7436", tween: [ "style", "${_mouse}", "msTransformOrigin", [50,50], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,50]}], position: 2500, duration: 0 },
                { id: "eid7437", tween: [ "style", "${_mouse}", "-o-transform-origin", [50,50], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,50]}], position: 2500, duration: 0 },
                ...
                { id: "eid6616", tween: [ "style", "${_bomb_bom}", "top", '38.19%', { fromValue: '38.3%'}], position: 15676, duration: 959 },
                ...
                { id: "eid5994", tween: [ "style", "${_bomb}", "width", '174px', { fromValue: '116px'}], position: 15676, duration: 409 },
                ...
                { id: "eid6619", tween: [ "style", "${_closed}", "opacity", '1', { fromValue: '0'}], position: 15676, duration: 409 },
