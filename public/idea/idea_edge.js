...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'boom_bg',
                type: 'rect',
                rect: ['0px', '-4px','1200px','853px','auto', 'auto'],
            ...
            },
            {
                id: 'bomb',
                type: 'image',
                rect: ['43.7%', '44%','9.6%','12%','auto', 'auto'],
                fill: ["rgba(0,0,0,0)",im+"bomb.png",'0px','0px']
            },
            {
                id: 'bomb_bom',
                type: 'image',
                rect: ['41.3%', '35.5%','10.8%','14.4%','auto', 'auto'],
    ...
    states: {
        "Base State": {
            ...
            "${_logolo}": [
                ["style", "left", '45.58%'],
                ["style", "opacity", '0.58536580132275']
            ],
            "${_Rectangle3}": [
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid6238", tween: [ "style", "${_logolo}", "opacity", '0.58536580132275', { fromValue: '0.58536580132275'}], position: 8325, duration: 0 },
                ...
                { id: "eid6322", tween: [ "style", "${_fla}", "-moz-transform-origin", [0,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,100]}], position: 9415, duration: 0 },
                { id: "eid6323", tween: [ "style", "${_fla}", "-ms-transform-origin", [0,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,100]}], position: 9415, duration: 0 },
                { id: "eid6324", tween: [ "style", "${_fla}", "msTransformOrigin", [0,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,100]}], position: 9415, duration: 0 },
                { id: "eid6325", tween: [ "style", "${_fla}", "-o-transform-origin", [0,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [0,100]}], position: 9415, duration: 0 },
                ...
                { id: "eid5998", tween: [ "style", "${_bomb}", "top", '41.06%', { fromValue: '44%'}], position: 15676, duration: 409 },
                ...
                { id: "eid6026", tween: [ "style", "${_bomb_bom}", "height", '52.22%', { fromValue: '14.36%'}], position: 16635, duration: 201 },
                { id: "eid6034", tween: [ "style", "${_bomb_bom}", "height", '42.48%', { fromValue: '52.22%'}], position: 16836, duration: 164 },
                ...
                { id: "eid6031", tween: [ "style", "${_bomb_bom}", "top", '19.88%', { fromValue: '38%'}], position: 16635, duration: 201 },
                { id: "eid6035", tween: [ "style", "${_bomb_bom}", "top", '26.47%', { fromValue: '19.88%'}], position: 16836, duration: 164 },
                ...
                { id: "eid6326", tween: [ "style", "${_mouse}", "-moz-transform-origin", [50,50], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,50]}], position: 2500, duration: 0 },
                { id: "eid6327", tween: [ "style", "${_mouse}", "-ms-transform-origin", [50,50], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,50]}], position: 2500, duration: 0 },
                { id: "eid6328", tween: [ "style", "${_mouse}", "msTransformOrigin", [50,50], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,50]}], position: 2500, duration: 0 },
                { id: "eid6329", tween: [ "style", "${_mouse}", "-o-transform-origin", [50,50], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,50]}], position: 2500, duration: 0 },
